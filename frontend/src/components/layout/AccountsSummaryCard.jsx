...
const AccountsSummaryCard = ({ grouped }) => {
  ...
  return (
         <div className="w-full max-w-[700px] mx-auto rounded-xl text-white border-none px-5 py-6 flex flex-col items-start justify-center box-border overflow-hidden shadow-lg mb-6 mt-2" style={{ background: 'var(--color-gradient-primary)' }}>
       ...
       <div className="sm:hidden flex w-full mt-4 relative">
         {mobileTabs.map(tab => (
           <button
             ...
             className="flex-1 py-2 text-center text-[13px] font-medium transition-all duration-200 cursor-pointer hover:opacity-100 hover:scale-105"
             style={{ 
